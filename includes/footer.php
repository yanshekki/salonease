...
?>
    ...
    <!-- 熱鍵幫助 Modal（由 JS 控制） -->
    <div id="hotkey-modal" class="hidden fixed inset-0 bg-black/40 z-[70] flex items-center justify-center" onclick="hideHotkeyHelp()">
        <div class="bg-white rounded-2xl shadow-xl w-full max-w-lg mx-4 overflow-hidden" onclick="event.stopImmediatePropagation()">
            <div class="px-5 py-4 border-b flex items-center justify-between">
                <div class="font-semibold text-lg">快捷鍵說明</div>
                <button onclick="hideHotkeyHelp()" class="text-2xl leading-none text-gray-400 hover:text-gray-600">×</button>
            </div>
            <div class="p-5 text-sm" id="hotkey-content">
                <!-- 由 assets/js/hotkeys.js 動態填入 -->
                <p class="text-[#5A5A5C]">正在載入快捷鍵清單...</p>
            </div>
            <div class="bg-gray-50 px-5 py-3 text-xs text-[#8A8A8C] flex justify-between">
